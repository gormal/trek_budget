defmodule TrekBudgetWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TrekBudgetWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TrekBudgetWeb.Gettext, "errors", msg, opts)
    end
  end
